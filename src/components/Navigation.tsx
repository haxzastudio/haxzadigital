    ...
    <>
      <nav className="px-6 lg:px-20 py-4 lg:py-6 flex justify-between items-center bg-haxza-bg/80 backdrop-blur-3xl sticky top-0 z-[100] border-b border-white/5">
        <Link to="/" className="flex items-center gap-2 group cursor-pointer no-underline relative z-[120]">
          <span className="text-xl lg:text-3xl font-black tracking-tighter text-white font-display">HAXZA</span>
        </Link>
        ...
        <div className="hidden lg:flex items-center gap-10 text-[10px] font-black uppercase tracking-[0.3em] text-white/40">
          ...
          <a 
            ...
            className="px-6 py-3 bg-haxza-accent text-white rounded-xl hover:bg-emerald-500 transition-all shadow-[0_10px_30px_rgba(35,134,54,0.3)] font-black no-underline flex items-center gap-2"
          >
            <MessageCircle className="w-5 h-5 fill-current" /> Começar Hoje
          </a>
        </div>
              ...
              <div className="flex flex-col gap-8 w-full items-center">
                ...
                >
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className="w-full inline-flex items-center justify-center gap-4 px-8 py-5 sm:px-10 sm:py-8 bg-haxza-accent text-white rounded-[2rem] sm:rounded-[2.5rem] font-black text-lg sm:text-2xl uppercase tracking-wider sm:tracking-widest no-underline shadow-[0_20px_40px_rgba(35,134,54,0.4)]"
                  >
                    Ativar Agora <Zap className="w-6 h-6 sm:w-8 sm:h-8 fill-current shrink-0" />
                  </a>
                </motion.div>
              </div>
