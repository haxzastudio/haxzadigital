      ...
      <main className="w-full">
        ...
        >
          ...
          <div className="max-w-[1280px] mx-auto px-6 lg:px-20 text-center flex flex-col items-center relative z-10">
            ...
            >
              <a href="https://wa.me/5511969454854?text=Ol%C3%A1%20Haxza%2C%20quero%20parar%20de%20perder%20clientes%20agora" target="_blank" rel="noopener noreferrer" className="group no-underline w-full sm:w-auto px-8 py-5 sm:px-10 sm:py-6 lg:px-14 lg:py-8 bg-haxza-accent hover:bg-emerald-500 text-white font-black rounded-2xl transition-all flex items-center justify-center gap-2 shadow-[0_20px_50px_rgba(35,134,54,0.3)] text-base sm:text-lg lg:text-xl uppercase tracking-widest cursor-pointer hover:scale-[1.02] active:scale-95">
                <span className="flex items-center gap-3 font-display text-center text-balance leading-tight">
                  Parar de Perder Clientes <ArrowRight className="w-5 h-5 lg:w-6 lg:h-6 shrink-0 group-hover:translate-x-1 transition-transform" />
                </span>
              </a>
            </motion.div>
              ...
              <div className="flex flex-col items-center gap-10 lg:gap-12">
                <div className="max-w-3xl">
                  ...
                  <a 
                    ...
                    className="w-full group relative px-6 py-4 sm:px-8 sm:py-6 lg:px-12 lg:py-8 bg-haxza-accent hover:bg-emerald-500 text-white font-black text-base sm:text-lg lg:text-xl tracking-wide sm:tracking-widest uppercase transition-all shadow-[0_30px_60px_rgba(35,134,54,0.3)] cursor-pointer overflow-hidden rounded-xl flex items-center justify-center gap-4 hover:scale-[1.02] active:scale-[0.98]"
                  >
                    <span className="relative z-10 flex items-center gap-3 lg:gap-4 text-center text-balance leading-tight">
                      Receber Clientes do Google <ArrowRight className="w-5 h-5 lg:w-6 lg:h-6 shrink-0 group-hover:translate-x-2 transition-transform" />
                    </span>
                  </a>
